...
/*문제  : 어떤 학생의 중간고사 총점은 322 , 과목수는 4개 입니다. 모두 항상 정수입니다.
	...
	1) 평균 저장 변수를 정수형 avgInt   2) 평균을 저장 변수를 실수 avgDouble 각각 해보세요.
...
public class A04DataCasting {
	...
	public static void main(String[] args) {
		...
		System.out.println("정수 형식 평균 :" + avgInt);
		...
		//322.0 나누기 4 => 실수값 소수점 이하 자릿수 계산
		System.out.println("실수 형식으로 변환 후 평균 :" + avgDouble);  
 ...
 * 
 * byte < short < int < lone < float < double
 *  1      2       4     8      4        8        바이트
 * 
